    ...
    <div className="dashboard">
      ...
      <div className="top_content">
        <div className="top_left col-6">
          <img src="/imgs/main01.png" alt="Doutura utilizando um computador" />
          <div>
      ...
      <div className="bottom_content">
        <img src="/imgs/main02.png" alt="desenho representando 3 emoções diferentes " />
        <div>
        ...
        <img src="/imgs/main03.png" alt="medico e seu enfermeiro de braços cruzados" />
        <div>
        ...
        <img src="/imgs/main04.png" alt="Jovem sorridente utilizando o aplicativo
        " />
      </div>
    </div>
  );
